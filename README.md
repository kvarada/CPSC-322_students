...
| Final exam | Monday, Dec 09, 2019, 7 PM, Location: [SRC A](https://learningspaces.ubc.ca/classrooms/src-a) | Do not make any travel plans during that period.|
...
|-------|------------|----------------|---------------------------|-----| 
|   1   | **Sept 3** <br> Imagine Day (no class)     |  **Sept 5** <br> What is AI? [1.1-1.3]  | Assignment 0 released | [lecture1_intro.pdf](lectures_102/lecture1_intro.pdf)|
...
|   8  | **Oct 22** <br> Planning: Representations and Forward Search <br> [6.1 (skip 6.1.3)] | **Oct 24** <br> Midterm prep (no class)| Assignment 2 due on Oct 21 at 11:59 PM <br> Midterm on Friday, Oct 25th from 6pm to 7pm at WOOD 2| [lecture14_planning_intro.pdf](lectures_102/lecture14_planning_intro.pdf)|
|   9  | **Oct 29** <br> Planning: Heuristics and CSP Planning [6.2, 6.4] | **Oct 31** <br> Logic: Intro and Syntax <br>[5.3.2] | Assignment 3 released on Oct 28th<br> Midterm returned | [lecture15_planning_CSP.pdf](lectures_102/lecture15_planning_CSP.pdf) <br>[lecture16_logic.pdf](lectures_102/lecture16_logic.pdf)|
|   10  | **Nov 5** <br> Logic: Semantics and Bottom-Up Proofs, BU Soundness and Completeness <br>[5.1, 5.3, 5.3.2] | **Nov 7** <br> Logic:Top-Down Proofs [5.5,5.3.2]<br>Logic: Datalog (basic concepts) [13.3]| | [lecture17_logic_bottom_up_proofs.pdf](lectures_102/lecture17_logic_bottom_up_proofs.pdf)<br>[Activity: BU_proofs](inclass_activities_102/102_In_class_activity_BU_proofs.pdf)<br>Try [this](https://raw.githubusercontent.com/kvarada/CPSC-322_students/master/AIspace_files/in-part-of.pl) with [AIspace deduction applet](http://aispace.org/deduction/deduction.jnlp)<br>[lecture18_logic_top_down_DL.pdf](lectures_102/lecture18_logic_top_down_DL.pdf)|
|   11  | **Nov 12** <br> Uncertainty: Probability Theory <br>[8.1, 8.1.1, 8.1.2 ] <br> Uncertainty: Conditional Probability [8.1.3 ] <br> Uncertainty: Conditional Independence [8.2] | **Nov 14** <br> Uncertainty: Intro to Belief Networks [8.3]| Assignment 3  due on Nov 11 at 11:59 PM | [lecture19_uncertainty_probability_intro.pdf](lectures_102/lecture19_uncertainty_probability_intro.pdf) <br> [Activity: Probability](inclass_activities_102/102_class_activity_probability.pdf) [(solution)](inclass_activities_102/102_class_activity_probability_sol.pdf)<br>[lecture20_uncertainty_independence](lectures_102/lecture20_uncertainty_independence_bayes_net.pdf)|
|   12  | **Nov 19** <br> Uncertainty: Belief Nets (indep. compactness, apps) [8.3, 8.3.2] | **Nov 21** <br> Uncertainty: BNet inference (intro to Variable Elimination)[8.4.1]|  |[lecture21_uncertainty_bayes_net](lectures_102/lecture21_uncertainty_bayes_net.pdf)<br>[lecture22_uncertainty_VE](lectures_102/lecture22_uncertainty_VE.pdf)|
|   13  | **Nov 26** <br> Uncertainty: Temporal Probabilistic Models [8.5.1] <br> Uncertainty: Hidden Markov Models [8.5.2] | **Nov 28** <br> Decision Theory: Single Stage Decisions [9.2] <br> Decision Theory: Sequential Decisions (policies) [9.3] Revision| Assignment 4 due on Nov 29 at 11:59 PM| [lecture23_uncertainty_Markov](lectures_102/lecture23_uncertainty_MM_HMM.pdf)<br> [lecture24_decision_theory_intro](lectures_102/lecture24_decision_theory_intro.pdf) |
