...
|   9  | **Oct 29** <br> Planning: Heuristics and CSP Planning [6.2, 6.4] | **Oct 31** <br> Logic: Intro and Syntax <br>[5.3.2] Logic: Semantics and Bottom-Up Proofs, BU Sound and Complete <br>[5.1, 5.3, 5.3.2] |  | |
|   10  | **Nov 5** <br> Logic: Datalog (basic concepts) [13.3] <br> Logic: Domain Modeling and Top-Down Proofs [5.5,5.3.2]| **Nov 7** <br> Uncertainty: Probability Theory <br>[8.1, 8.1.1, 8.1.2 ]| | |
