...
|   12  | **Nov 19** <br> Uncertainty: Belief Nets (indep. compactness, apps) [8.3, 8.3.2] <br> Uncertainty: BNet inference (intro to Variable Elimination)[8.4.1]  | **Nov 21** <br> Uncertainty: Temporal Probabilistic Models [8.5.1] <br> Uncertainty: Hidden Markov Models [8.5.2]|  |[lecture21_uncertainty_bayes_net](lectures_102/lecture21_uncertainty_bayes_net.pdf)<br>[lecture22_uncertainty_VE](lectures_102/lecture22_uncertainty_VE.pdf)|
|   13  | **Nov 26** <br> Decision Theory: Single Stage Decisions [9.2] | **Nov 28** <br> Decision Theory: Sequential Decisions (policies) [9.3] Revision| Assignment 4 due on Nov 29 at 11:59 PM| |
