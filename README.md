...
|   6  | **Oct 8** <br> CSPs: Arc Consistency and Domain Splitting <br> [4.5, 4.6] | **Oct 10** <br> CSPs: Local Search <br> [4.7]  | | Activity: [CSP_arc_consistency](inclass_activities_102/102_CSP_arc_consistency_domain_splitting.pdf) [(solution)](inclass_activities_102/102_CSP_arc_consistency_domain_splitting_soln.pdf)|
|   7  | **Oct 15** <br>  CSPs: Stochastic Local Search <br> [4.7.1, 4.7.2, 4.7.4] <br> | **Oct 17** <br> CSPs: SLS variants (Sim. Annealing + Pop. based) <br> [4.7.3, 4.8] | | Activity: [CSP_local_search](inclass_activities_102/102_CSP_local_search.pdf)[(solution)](inclass_activities_102/102_CSP_local_search_soln.pdf)|
