...
|   7  | **Oct 15** <br>  CSPs: Stochastic Local Search <br> [4.7.1, 4.7.2, 4.7.4] <br> [4.7.3, 4.8] <br> CSPs: SLS variants (Sim. Annealing + Pop. based) <br> [4.7.3, 4.8] | **Oct 17** <br> Planning: Representations and Forward Search <br> [6.1 (skip 6.1.3)]| |  
