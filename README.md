...
|   3   | **Sept 17** <br> Search: Uninformed search, DFS and BFS <br>[3.5.1, 3.5.2] | **Sept 19** <br> Search: IDS, search with costs <br> [3.5.3, 3.5.4, 3.7.3] <br> Search: Heuristic Search [3.6]  | Assignment 1 released on Sep 16| [BFS_DFS](inclass_activities_102/102_BFS_and_DFS.pdf) <br> [BFS_DFS_soln](inclass_activities_102/102_BFS_and_DFS_soln.pdf)|
|   4  | **Sept 24** <br> Search: BestFS, A*, optimality <br> [3.6.1] | **Sept 26** <br> Branch & Bound, IDA*, Pruning <br>[3.7.1, 3.7.4] |  | |
|   5  | **Oct 1** <br> CSPs: Introduction [4.1, 4.2] | **Oct 3** <br> CSPs: Search and Consistency <br> [4.3, 4.4]|  Assignment 1 due on Sep 30 at 11:59 PM | [CSP_intro](inclass_activities_102/102_CSP_intro.pdf) <br> [CSP_intro_soln](inclass_activities_102/102_CSP_intro_soln.pdf)<br>[CSP_search](inclass_activities_102/102_CSP_search.pdf)<br>[CSP_search_soln](inclass_activities_102/102_CSP_search_soln.pdf)|
|   6  | **Oct 8** <br> CSPs: Arc Consistency and Domain Splitting <br> [4.5, 4.6] | **Oct 10** <br> CSPs: Local Search <br> [4.7]  | | [CSP_arc_consistency](inclass_activities_102/102_CSP_arc_consistency_domain_splitting.pdf)<br> [CSP_arc_consistency_soln](inclass_activities_102/102_CSP_arc_consistency_domain_splitting_soln.pdf)|
|   7  | **Oct 15** <br>  CSPs: Stochastic Local Search <br> [4.7.1, 4.7.2, 4.7.4] <br> | **Oct 17** <br> CSPs: SLS variants (Sim. Annealing + Pop. based) <br> [4.7.3, 4.8] | | [CSP_local_search](inclass_activities_102/102_CSP_local_search.pdf)<br>[CSP_local_search_soln](inclass_activities_102/102_CSP_local_search_soln.pdf)|
|   8  | **Oct 22** <br> Planning: Representations and Forward Search <br> [6.1 (skip 6.1.3)] <br> Planning: Heuristics and CSP Planning [6.2, 6.4]| **Oct 24** <br> Midterm prep (no class)| Assignment 2 due on Oct 21 at 11:59 PM <br> Midterm on Friday, Oct 25th from 6pm to 7pm at WOOD 2| |
